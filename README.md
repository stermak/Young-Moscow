...
<ul><li>Просмотр интересных событий по Москве и Московской области</li><li>Добавление событий в избранное</li><li>Отметка на карте мест, которые вам понравились</li><li>Поиск по событиям и местам</li><li>Поиск достопримечательностей</li><li>Составление маршрута до достопримечательности или места события</li><li>Редактирование профиля</li><li>Фильтрация событий по дате, месту и типу</li><li>Регистрация и вход в систему для сохранения избранных мероприятий на устройстве пользователя</li></ul>
