...
// Определение класса репозитория KudaGoRepository, который обеспечивает доступ к данным, полученным из API
...
// pageSize - количество элементов, выводимых на странице, page - номер страницы
    suspend fun getEvents(
        ...
        val response = api.getEvents(
            ...
            pageSize = pageSize, // Задание количества элементов на странице
            page = page, // Задание номера страницы
            order_by = "-publication_date" // Задание порядка сортировки по дате публикации
        )
